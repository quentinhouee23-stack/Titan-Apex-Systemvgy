...
body {
  ...
  position: fixed;
  inset: 0; /* Remplace top, bottom, left, right: 0 */
  width: 100%;
  height: 100%;
  margin: 0;
  padding: 0 !important;
...
header {
  ...
  main { position: relative; z-index: 10; padding: 0 20px; }
...
#stock.active { 
  display: flex; 
  flex-direction: column; 
  height: 100%; /* CHANGÉ : 100% au lieu de 100dvh */
  overflow: hidden; 
  padding-bottom: 0; 
}

.tab-content.active:not(#stock) {
  padding-bottom: 140px; /* Un peu plus d'espace pour scroller au dessus de la nav */
  overflow-y: auto;
  height: 100%; /* CHANGÉ : 100% au lieu de 100dvh */
